...
@section('title', 'Form Edit Operator')
@section('main')
    <!-- Main Content -->
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="#">Edit Operator</a></div>
                    <div class="breadcrumb-item">Form Edit Operator</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Form Edit Operator</h2>
                <p class="section-lead">Ini adalah halaman untuk Mengedit akun operator kedalam sistem.</p>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('operator.update', $users->id) }}" runat="server"
