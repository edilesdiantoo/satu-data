        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Data Permohonan Data</a></div>
                    <div class="breadcrumb-item">Tabel Permohonan Data</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Permohonan Data</h2>
                <p class="section-lead">
                    Ini adalah halaman Permohonan Data dalam Sistem Jambi data dan Analitik Center.
                </p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4>Daftar Data Permohonan Data</h4>
                                <a href="{{ route('permohonan-data.create') }}" class="btn btn-primary">Tambah Data <i
                                                        ...
                                                        <div class="dropdown d-inline mr-2">
                                                            ...
                                                            <div class="dropdown-menu" x-placement="bottom-start"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('permohonan-data.edit', $item->id) }}">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('permohonan-data.destroy', $item->id) }}"
