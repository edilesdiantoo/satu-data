...
@section('title', 'Form Tambah Akun OPD')
@section('main')
    <!-- Main Content -->
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="#">Tambah Akun OPD</a></div>
                    <div class="breadcrumb-item">Form Tambah Akun OPD</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Form Tambah Akun OPD</h2>
                <p class="section-lead">Ini adalah halaman untuk menambahkan akun Akun OPD kedalam sistem.</p>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('akunopd.store') }}" runat="server" enctype="multipart/form-data"
                                    method="post">
                                    @csrf
