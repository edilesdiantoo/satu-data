                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('csv_upload', $datasets->id) }}" enctype="multipart/form-data"
                                    method="post">
                                    @csrf
                    ...
                    <div class="col-4">
                        <div class="card" id="add_kolom">
                            ...
                            <div class="card-body">
                                <form action="{{ route('tambah_kolom', $datasets->id) }}" method="post">
                                    @csrf
                                    <div class="form-group">
                    ...
                    <div class="col-4">
                        <div class="card" id="edit_kolom">
                            ...
                            <div class="card-body">
                                <form action="{{ route('edit_nama_kolom', $datasets->id) }}" method="post">
                                    @csrf
                                    <div class="form-group">
                    ...
                    <div class="col-4">
                        <div class="card" id="delete_kolom">
                            ...
                            <div class="card-body">
                                <form action="{{ route('delete_kolom', $datasets->id) }}" method="post">
                                    @csrf
                                    <div class="form-group">
