...
@section('title', 'Form Tambah Buku Digital')
@section('main')
    <!-- Main Content -->
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Buku Digital</h1>
            ...
            <div class="section-body">
                <h2 class="section-title">Form Tambah Buku Digital</h2>
                <p class="section-lead">Ini adalah halaman untuk menambahkan Buku Digital kedalam sistem.</p>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('buku-digital.store') }}" enctype="multipart/form-data"
