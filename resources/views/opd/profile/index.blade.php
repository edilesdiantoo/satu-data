            ...
            <div class="section-body">
                <div class="col-12 mb-4">
                    <div class="hero text-white hero-bg-image"
                        style="background-image: url({{ asset('assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg') }});">
                ...
                <div class="row mt-sm-4">
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('opdprofile.update', Auth::user()->id) }}" runat="server"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_opd"
                                            class="form-control @error('id_opd')is-invalid @enderror select2 " readonly>
                                            @foreach ($opd as $item_opd)
                                                @if (Auth::user()->id_opd == $item_opd->id)
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('change_password.opd') }}" method="post">
                                    @csrf
                                    @method('patch')
                                    <div class="form-group">
