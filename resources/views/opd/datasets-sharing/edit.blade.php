...
@section('title', 'Form Edit Datasets Sharing')
@section('main')
    <!-- Main Content -->
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Datasets Sharing</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Datasets Sharing</a></div>
                    <div class="breadcrumb-item"><a href="#">Edit Datasets Sharing</a></div>
                    <div class="breadcrumb-item">Form Edit Datasets Sharing</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Form Edit Datasets Sharing</h2>
                <p class="section-lead">Ini adalah halaman untuk Mengubah Datasets Sharing kedalam sistem.</p>
                <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-warning alert-has-icon">
                                ...
                                <div class="alert-body">
                                    <div class="alert-title">Alasan Datasets Share Butuh Perbaikan</div>
                                    {{ $datasets->alasan }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <form action="{{ route('opddatasetsshare.update', $datasets->id) }}" enctype="multipart/form-data"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>Sektor Datasets</label>
                                        <select name="sektor"
                                            class="form-control @error('sektor')is-invalid @enderror select2 ">
                                            <option selected disabled>=== Pilih Salah Satu ===</option>
                                            <optgroup label="Sosial dan Kependudukan">
                                                <option value="01"
                                                    {{ old('sektor', $datasets->sektor) == '01' ? 'selected' : '' }}>
                                                    Kesehatan
                                                </option>
                                                <option value="02"
                                                    {{ old('sektor', $datasets->sektor) == '02' ? 'selected' : '' }}>
                                                    Pendidikan
                                                </option>
                                                <option value="03"
                                                    {{ old('sektor', $datasets->sektor) == '03' ? 'selected' : '' }}>
                                                    Bencana
                                                </option>
                                                <option value="04"
                                                    {{ old('sektor', $datasets->sektor) == '04' ? 'selected' : '' }}>
                                                    Pariwisata
                                                </option>
                                                <option value="05"
                                                    {{ old('sektor', $datasets->sektor) == '05' ? 'selected' : '' }}>
                                                    Kependudukan</option>
                                                <option value="06"
                                                    {{ old('sektor', $datasets->sektor) == '06' ? 'selected' : '' }}>Indeks
                                                    Desa Membangunan</option>
                                            </optgroup>
                                            <optgroup label="Sumber Daya Alam">
                                                <option value="07"
                                                    {{ old('sektor', $datasets->sektor) == '07' ? 'selected' : '' }}>
                                                    Tanaman
                                                    Pangan</option>
                                                <option value="08"
                                                    {{ old('sektor', $datasets->sektor) == '08' ? 'selected' : '' }}>
                                                    Hortikultura</option>
                                                <option value="09"
                                                    {{ old('sektor', $datasets->sektor) == '09' ? 'selected' : '' }}>
                                                    Peternakan
                                                </option>
                                            </optgroup>
                                            <optgroup label="Perekonomian">
                                                <option value="10"
                                                    {{ old('sektor', $datasets->sektor) == '10' ? 'selected' : '' }}>
                                                    Keuangan
                                                </option>
                                                <option value="11"
                                                    {{ old('sektor', $datasets->sektor) == '11' ? 'selected' : '' }}>
                                                    Pembangunan</option>
                                                <option value="12"
                                                    {{ old('sektor', $datasets->sektor) == '12' ? 'selected' : '' }}>
                                                    Koperasi
                                                </option>
                                                <option value="13"
                                                    {{ old('sektor', $datasets->sektor) == '13' ? 'selected' : '' }}>
                                                    Perdagangan</option>
                                                <option value="14"
                                                    {{ old('sektor', $datasets->sektor) == '14' ? 'selected' : '' }}>
                                                    Perizinan
                                                </option>
                                            </optgroup>
                                            <optgroup label="Pemerintahan">
                                                <option value="15"
                                                    {{ old('sektor', $datasets->sektor) == '15' ? 'selected' : '' }}>
                                                    Kepegawaian</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control @error('db_datasets')is-invalid @enderror"
