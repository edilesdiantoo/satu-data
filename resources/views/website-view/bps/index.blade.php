                                ...
                                <select name="kategori" id="kategori" class="form-select" onchange="this.form.submit()">
                                    ...
                                    @for ($i = 0; $i < $jumlahkategori; $i++)
                                        <option value="{{ $kategori['data'][1][$i]['title'] }}"
                                            {{ app('request')->input('kategori') == $kategori['data'][1][$i]['title'] ? 'selected' : '' }}>
                            ...
                            <div class="card">
                                <div class="g-2 py-3 row">
                                    <div class="position-relative px-4 col-lg-1 col-md-2 col-sm-3 col-4 my-auto"
                                        style="width: 7.33rem;">
                                        <img src="{{ asset('assets/bpsicon.png') }}" alt=""
