                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <span class="badge bg-info" data-aos="fade-right">
                            Dipublish : {{ $berita->created_at->format('d M Y H:i') }}
                        </span>
                        ...
                        <div class="text-center">
                            <img class="img-fluid rounded mt-2 mb-2" data-aos="zoom-in-up" style="width: 100%; "
                    ...
                    <div class="col-md-4 gy-3">
                        ...
                        <form method="get" action="{{ route('web-berita.index') }}" id="form" data-aos="fade-left">
                            ...
                            <div class="card" data-aos="fade-left">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <a href="{{ route('web-berita.show', ['id' => $item->id, 'slug' => $item->slug]) }}"
                                                class="text-black">
