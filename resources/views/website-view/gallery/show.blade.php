                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <span class="badge bg-info" data-aos="fade-right">
                            Dipublish : {{ $gallery->created_at->format('d M Y H:i') }}
                        </span>
                    ...
                    <div class="col-md-4 gy-3">
                        ...
                        <form method="get" action="{{ route('web-gallery.index') }}" id="form" data-aos="fade-left">
                        ...
                        @foreach ($list as $item)
                            <div class="row" data-aos="fade-left">
                                ...
                                <div class="col-md-6 mb-4">
                                    <a href="{{ route('web-gallery.show', ['id' => $item->id, 'slug' => $item->slug]) }}"
                                        class="text-black">
                                        <span><strong>{{ $item->judul }}</strong></span></a><br>
                                    <p class="badge bg-info small-text">Dipublish : {{ $item->created_at->format('d M Y') }}
                                    </p>
                                </div>
                            </div>
                        @endforeach
