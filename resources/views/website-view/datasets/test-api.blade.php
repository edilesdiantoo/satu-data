...
@section('main')
    ...
    <main id="main">
        <?php
        $text = preg_replace('~[^\pL\d]+~u', '-', $datasets['data']['judul']);
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <div class="mt-4">
                                        ...
                                        @endif
                                        <br>
                                        <a href="{{ route('organisasi.informasi') }}?judul={{ $opd->nama_opd }}"
                                            class="text-uppercase fw-bolder text-dark">{{ $opd->nama_opd }}</a>
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <h4 class="mt-3">{{ $datasets['data']['judul'] }}</h4>
                                    <p><?php echo $datasets['data']['deskripsi']; ?>
                                        <br>
                                        <i>
                                            (Sumber : {{ $datasets['data']['nama_opd'] }},
                                                    ...
                                                    <table class="table table-striped">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td>{{ $datasets['data']['nama_opd'] }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>Judul Kegiatan</th>
                                                                <td>:</td>
                                                                <td>{{ $datasets['data']['judul'] }}</td>
                                                            </tr>
                                                            <tr>
